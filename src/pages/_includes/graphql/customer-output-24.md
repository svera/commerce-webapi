import AttributeValueInterface from '/src/pages/_includes/graphql/attribute-value-interface.md'
...
`custom_attributesV2(attributeCodes: [ID!])` | [AttributeValueInterface](#attributevalueinterface-attributes)| Customer's custom attributes
